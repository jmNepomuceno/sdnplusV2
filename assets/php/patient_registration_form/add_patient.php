<?php 
    ...
    try {
        ...
        $pat_email_cwa = $_POST['pat_email_cwa'];
        ...
        $stmt->bindParam(24, $pat_homephone_no_pa, PDO::PARAM_STR);
        $stmt->bindParam(25, $pat_mobile_no_pa, PDO::PARAM_STR);
        ...
        $stmt->bindParam(43, $pat_email_cwa, PDO::PARAM_STR);
